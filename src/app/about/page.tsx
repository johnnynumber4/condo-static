      ...
      <Box sx={{ my: 4 }}>
        ...
        <Paper sx={{ p: 4, mb: 4 }}>
          ...
          <List sx={{ pl: 2, mb: 3 }}>
            ...
            <ListItem sx={{ display: 'list-item' }}>
              5 options for swimming (indoor pool, jacuzzi, kiddie pool, lazy river & ocean)
            </ListItem>
            <ListItem sx={{ display: 'list-item' }}>
          ...
          <Typography variant="body1" paragraph>
            We hope that you enjoy your stay as much as we like coming down here. 
            This website acts as a house manual, please refer to it as needed to make your stay more comfortable.
          </Typography>
        </Paper>
